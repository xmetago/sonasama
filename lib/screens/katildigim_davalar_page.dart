...
class KatildigimDavalarPage extends StatelessWidget {
  const KatildigimDavalarPage({super.key});
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        const Text('8-Hükmüm  :', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                        const SizedBox(width: 4),
                        Expanded(
                          child: Row(
                            children: [
                              Text('Katıldığım', style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                              const Spacer(),
                              Icon(Icons.thumb_down_alt_outlined, size: 25, color: Colors.red),
                              Icon(Icons.thumb_up_alt_outlined, size: 25, color: Colors.green),
                            ],
