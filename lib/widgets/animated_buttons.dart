...
class AnimatedDangerButton extends StatefulWidget {
  final String text;
  final VoidCallback? onPressed;
  final IconData? icon;
  final double? width;
  ...
  @override
  State<AnimatedDangerButton> createState() => _AnimatedDangerButtonState();
}

class _AnimatedDangerButtonState extends State<AnimatedDangerButton>
    with SingleTickerProviderStateMixin {
  late AnimationController _controller;
  late Animation<double> _scaleAnimation;
  late Animation<double> _shadowAnimation;
